...
const template: DynamoDBValidationTemplate = {
  ...
  "metaTags": "",
  "multiFile": "",
  "name": "General FS178 Spec Validator",
  "pages": "",
  "rules": [
    {
        ...
        "schema": [
          {
            ...
            "type": "string",
            "array": true,
            "value": ["SEA STUDENT PERFORMANCE READING LANGUAGE ARTS", "LEA STUDENT PERFORMANCE READING LANGUAGE ARTS", "SCHOOL STUDENT PERFORMANCE READING LANGUAGE ARTS"]
          },
          {
          ...
          },
          {
            ...
            "regex": "^[A-Z]{2}(SEA|LEA|SCH)STUPERRLA[A-Za-z0-9]{0,7}(\\.csv)$",
            "type": "string",
            "maxLength": 25
          },
          {
