...
const template: DynamoDBValidationTemplate = {
  ...
  "metaTags": "",
  "multiFile": "",
  "name": "General FS188 Spec Validator",
  "pages": "",
  "rules": [
    {
        ...
        "schema": [
          {
            ...
            "type": "string",
            "array": true,
            "value": ["SEA RLA ASSESSMENT PARTICIPATION", "LEA RLA ASSESSMENT PARTICIPATION", "SCHOOL RLA ASSESSMENT PARTICIPATION"]
          },
          {
          ...
          },
          {
            ...
            "regex": "^[A-Z]{2}(SEA|LEA|SCH)STUPARTRL[A-Za-z0-9]{0,7}(\\.csv)$",
            "type": "string",
            "maxLength": 25
          },
          {
