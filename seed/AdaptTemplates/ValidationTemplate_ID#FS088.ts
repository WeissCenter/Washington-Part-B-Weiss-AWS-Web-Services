...
const template: DynamoDBValidationTemplate = {
  ...
  "metaTags": "",
  "multiFile": "",
  "name": "General FS088 Spec Validator",
  "pages": "",
  "rules": [
    {
        ...
        "schema": [
          {
            ...
            "type": "string",
            "array": true,
            "value": ["SEA CHILDREN WITH DISABILITIES (IDEA) DISCIP ACT", "LEA CHILDREN WITH DISABILITIES (IDEA) DISCIP ACT"]
          },
          {
          ...
          },
          {
            ...
            "regex": "^[A-Z]{2}(SEA|LEA)CWDIDEADR[A-Za-z0-9]{0,7}(\\.csv)$",
            "type": "string",
            "maxLength": 25
          },
          {
