...
const template: DynamoDBValidationTemplate = {
  ...
  "metaTags": "",
  "multiFile": "",
  "name": "General FS006 Spec Validator",
  "pages": "",
  "rules": [
    {
        ...
        "schema": [
          {
            ...
            "type": "string",
            "array": true,
            "value": ["SEA CHILDREN WITH DISAB (IDEA) MULTI SUSPEN EXPU", "LEA CHILDREN WITH DISAB (IDEA) MULTI SUSPEN EXPU"]
          },
          {
          ...
          },
          {
            ...
            "regex": "^[A-Z]{2}(SEA|LEA)CDIDEAMSE[A-Za-z0-9]{0,7}(\\.csv)$",
            "type": "string",
            "maxLength": 25
          },
          {
