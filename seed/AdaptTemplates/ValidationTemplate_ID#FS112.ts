...
const template: DynamoDBValidationTemplate = {
  ...
  "metaTags": "",
  "multiFile": "",
  "name": "General FS112 Spec Validator",
  "pages": "",
  "rules": [
    {
        ...
        "schema": [
          {
            ...
            "type": "string",
            "array": true,
            "value": ["SEA SPECIAL ED PARAPROFESSIONALS", "LEA SPECIAL ED PARAPROFESSIONALS"]
          },
          {
          ...
          },
          {
            ...
            "regex": "^[A-Z]{2}(SEA|LEA)SPEDPPROF[A-Za-z0-9]{0,7}(\\.csv)$",
            "type": "string",
            "maxLength": 25
          },
          {
